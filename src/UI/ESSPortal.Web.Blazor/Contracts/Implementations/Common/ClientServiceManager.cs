...
internal sealed class ClientServiceManager : IClientServiceManager
{
    ...
    private readonly Lazy<IAppStateService> _appStateService;
    ...
    public ClientServiceManager(IServiceProvider serviceProvider)
    {
        ...
        _appStateService = new Lazy<IAppStateService>(() => _serviceProvider.GetRequiredService<IAppStateService>());
    ...
    public IAppStateService AppStateService => _appStateService.Value;
