...
using ESSPortal.Web.Blazor.Contracts.Implementations.AppServices;
using ESSPortal.Web.Blazor.Contracts.Implementations.Common;
using ESSPortal.Web.Blazor.Contracts.Implementations.Services;
...
namespace EssPortal.Web.Blazor.Utilities;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddBlazorClientServices(this IServiceCollection services, IConfiguration configuration)
    {
        try
        {
