...
public interface IApiService
{
    ...
    Task<AppResponse<T>> HandleGetRequest<T>(string endpoint);
    Task<AppResponse<TResponse>> HandlePostRequest<TRequest, TResponse>(string endpoint, TRequest request);
    Task<AppResponse<TResponse>> HandlePutRequest<TRequest, TResponse>(string endpoint, TRequest request);
    Task<AppResponse<T>> HandleDeleteRequest<T>(string endpoint);
    AppResponse<T> ConvertApiResponse<T>(AppResponse<T?> apiResponse);
}
