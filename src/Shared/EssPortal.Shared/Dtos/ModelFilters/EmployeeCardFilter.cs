...
public record EmployeeCardFilter : BaseFilter
{
    ...
    public string? EthnicOrigin { get; init; }
    public string? ApplicationMethod { get; init; }
    public string? EmployeeType { get; init; }
    public string? TerminationCategory { get; init; }
    ...
    public Dictionary<string, string?> CustomQueryParameters()
    {
       ...
       AddIf(nameof(Disabled), Disabled);
       ...
       AddIf(nameof(MaritalStatus), MaritalStatus);
       AddIf(nameof(Religion), Religion);
       AddIf(nameof(EthnicOrigin), EthnicOrigin);
       ...
       AddIf(nameof(ApplicationMethod), ApplicationMethod);
       ...
       AddIf(nameof(EmployeeType), EmployeeType);
       ...
       AddIf(nameof(TerminationCategory), TerminationCategory);
